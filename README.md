...
div.Section0{page:Section0;}</style></head><body style="tab-interval:21pt;text-justify-trim:punctuation;" ><!--StartFragment--><div class="Section0"  style="layout-grid:18.0000pt;" ><p class=MsoNormal ><span style="position:absolute;z-index:1;margin-left:1019.6667px;
margin-top:384.4167px;width:451.0000px;height:79.0000px;" ><a href="Aboutme.html"><img width="451"  height="79"  src="Home.files/Home0.png" ></a></span><img width="1510"  height="834"  src="Home.files/Home1.png" ><span style="mso-spacerun:'yes';font-family:Calibri;mso-fareast-font-family:SimSun;
